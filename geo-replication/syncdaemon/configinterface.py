...
CONFIGS = (
    ("peersrx . .",
     ...
     "",
     "/glusterfs/soft/var/lib/glusterd/geo-replication/${mastervol}_${remotehost}_"
     "${slavevol}/"),
    ("peersrx .",
     "gluster_params",
    ...
    ("peersrx . .",
     ...
     "-i /glusterfs/soft/var/lib/glusterd/geo-replication/tar_ssh.pem"),
    ("peersrx . .",
     "changelog_log_file",
     "",
    ...
    ("peersrx . .",
     "working_dir",
     "${prefix}/var/run/gluster/${mastervol}/${eSlave}",
